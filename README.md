# 💫 About Me:
Merhaba ,Ben Cem Tekin. Çanakkale Onsekiz Mart Üniversitesi 4.sınıf Bilgisayar Mühendisliği  öğrencisiyim.<br>🔭 Java Spring Framework ile web tabanlı uygulamalar geliştirme<br>👀 C# Windows form kullanarak masaüstü uygulamalar geliştirme<br> 🖥️HTML-CSS-Bootstrap-Php dilleri kullanarak web sitelerin tasarlanması <br>🤓 SQL veritabanı sorgulama dili ve ilişkisel veri tabanı tasarlanması ile ilgileniyorum.<br>🌱 Yeniliklere açık, öğrenmeye istekli ,değişime uyum sağlayan ,araştırmayı seven,<br>⚡ Kendimi her geçen gün daha fazla geliştirmeye çalışan biriyim
